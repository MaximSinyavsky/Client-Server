...
В JSON ключи всегда должны быть строками, а вот значения могут быть различными типами данных.
### Ключи:
* Строки (String): Ключи всегда заключены в двойные кавычки.
...
### Значения:
* Строки (String): Должны быть заключены в двойные кавычки.
...
* Объекты (Object): Вложенные структуры данных, содержащие пары "ключ-значение".
...
* Массивы (Array): Списки значений, заключенные в квадратные скобки.
