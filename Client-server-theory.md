...
### Обновляющий токен (Refresh Token):
...
### Токен CSRF (Cross-Site Request Forgery Token):
...
#### Частичное выполнение задач на клиентской стороне:
...
#### Постоянное или частое соединение с сервером:
...
#### Веб-приложения с функцией оффлайн-режима:
...
#### Мобильные приложения для работы офлайн:
